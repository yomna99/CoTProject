...
$(document).ready(function () {
    $.ajax({
        url: 'https://driveguardian.me/api/profile/',
        type: 'GET',
        headers: {
    ...
    document.getElementById("search button").onclick = function () {
        ...
        $.ajax({
            url: 'https://driveguardian.me/api/profile/search/' + search,
            type: 'GET',
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
...
$.ajax({
    url: 'https://driveguardian.me/api/profile/admin/2',
    type: 'GET',
    headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
$.ajax({
    url: 'https://driveguardian.me/api/profile/admin/1',
    type: 'GET',
    headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
$.ajax({
    url: 'https://driveguardian.me/api/sensor',
    type: 'GET',
    headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
...
$.ajax({
    url: 'https://driveguardian.me/api/profile/' + mail,
    type: 'GET',
    headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json',
